  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 right-0 z-[50000] bg-gradient-to-b from-black/80 via-black/40 to-transparent pt-3 pb-12 px-4 pointer-events-auto"
      >
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-black/80 hover:bg-black text-white border border-white/20 shadow-2xl backdrop-blur-md transition-all cursor-pointer z-[50000]"
            title="Quitter (Retour)"
          >
            <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-red-500" />
