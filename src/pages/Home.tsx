...
import RoulettePromotion from '../components/RoulettePromotion';
...
import { getAllHubPlatforms, subscribeCustomPlatforms } from '../utils/customPlatforms';
...
const Home: React.FC = () => {
  ...
  const [customPlatformsVersion, setCustomPlatformsVersion] = useState(0);
  useEffect(() => subscribeCustomPlatforms(() => setCustomPlatformsVersion(v => v + 1)), []);

  const platformsItems = useMemo(() => {
    const defaultPlatforms = [
      { id: '8', src: "https://u.cubeupload.com/mystic/8df6ce62504c1ab31aab.png", video: "https://media.tenor.com/hd7jyV_dMS8AAAPo/netflix-media-services-provider.mp4", title: "Netflix", route: "/provider/8", label: t('home.filmsAndSeries', { count: 2817 }) },
      { id: '119', src: "https://u.cubeupload.com/mystic/b222691607d658c2fa52.png", video: "https://media.tenor.com/T7L_NCdPIvAAAAPo/prime-video.mp4", title: "Prime Video", route: "/provider/119", label: t('home.filmsAndSeries', { count: 2799 }) },
      { id: '531', src: "https://u.cubeupload.com/mystic/35734306149c1a6eb0a9.png", video: "https://media4.giphy.com/media/qCEXQzkScYOBIRusVA/giphy.mp4", title: "Paramount+", route: "/provider/531", label: t('home.filmsAndSeries', { count: 502 }) },
      { id: '337', src: "https://u.cubeupload.com/mystic/c40fe782c450e170eea6.png", video: "https://media.tenor.com/h6-0yzk8pbAAAAPo/disney-disney-plus.mp4", title: "Disney+", route: "/provider/337", label: t('home.filmsAndSeries', { count: 1152 }) },
      { id: '338', src: "https://u.cubeupload.com/mystic/hUzeosd33nzE5MCNsZxC.png", video: "https://i.giphy.com/media/vBjLa5DQwwxbi/giphy.mp4", title: "Marvel Studios", route: "/provider/338", label: t('home.filmsAndSeries', { count: 65 }) },
      { id: '350', src: "https://u.cubeupload.com/mystic/b2fb6956993e2ee5b4e3.png", video: "https://media.tenor.com/Oxl9xEn7kTEAAAPo/applo-tv.mp4", title: "Apple TV+", route: "/provider/350", label: t('home.filmsAndSeries', { count: 138 }) },
      { id: '355', src: "https://u.cubeupload.com/mystic/ky0xOc5OrhzkZ1N6KyUx.png", video: "https://i.giphy.com/media/3o7TKt3pMpzozdUsus/giphy.mp4", title: "Warner Bros", route: "/provider/355", label: t('home.filmsAndSeries', { count: 645 }) },
      { id: '356', src: "https://u.cubeupload.com/mystic/2Tc1P3Ac8M479naPp1kY.png", video: "https://media.tenor.com/ag74wyAzYkMAAAPo/dc-comics-dceu.mp4", title: "DC Comics", route: "/provider/356", label: t('home.filmsAndSeries', { count: 98 }) },
      { id: '384', src: "https://imgs.search.brave.com/Vy1IBbYyWsYzAbAq1xOIIFFnQm8R8V5-RgWR3lOnJXg/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy90/aHVtYi9iL2IzL0hC/T19NYXhfJTI4MjAy/NSUyOS5zdmcvMjUw/cHgtSEJPX01heF8l/MjgyMDI1JTI5LnN2/Zy5wbmc", video: "https://media.tenor.com/7xmvr-fKGLMAAAAd/hbo-max-warner-bros-pictures.gif", title: "HBO MAX", route: "/provider/384", label: "HBO MAX" },
    ];

    return getAllHubPlatforms(defaultPlatforms).map(p => ({
      id: p.id,
      src: p.src,
      video: p.video,
      alt: p.title || p.label || 'Platform',
      route: p.route,
      label: p.label || p.title,
    }));
  }, [t, customPlatformsVersion]);
