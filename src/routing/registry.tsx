...
export const ROUTES: RouteEntry[] = [
  ...
  { path: '/tv-francaise',            loader: lz(() => import('../pages/TvFrancaisePage')) },
  { path: '/hub/youtube',             loader: lz(() => import('../pages/YouTubeHubPage')) },
  { path: '/hub/twitch',              loader: lz(() => import('../pages/TwitchHubPage')) },
