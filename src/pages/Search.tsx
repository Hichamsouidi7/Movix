                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className="relative">
                                    <div className="flex bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden">
                                        <button
                                            type="submit"
                                            className="self-center ml-2 p-2 text-white/40 hover:text-white hover:bg-white/10 transition-colors cursor-pointer shrink-0 rounded-xl active:scale-95"
                                            title={t('common.search') || 'Lancer la recherche'}
                                        >
                                            <SearchIcon size={20} />
                                        </button>
                                        <input
